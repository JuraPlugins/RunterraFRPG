...
export function CharacterBuilder() {
  ...
  const validSteps = [
    ...
    Boolean(selectedClass && character.classSkills.length === selectedClass.skillCount && (selectedClass.id !== "buyucu" || character.cantrips.length === 3) && (character.level < 3 || character.specialization) && patronComplete),
