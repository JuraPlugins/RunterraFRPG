...
const collections = [
  { href: "/kulliyat/siniflar", image: "/art/classes-cover.png", title: "Sınıflar", kicker: "13 sınıf · 26 uzmanlık", description: "Savaş alanında hangi araçlarla iz bırakacağını seç. Her sınıfın rolünü, kaynağını ve uzmanlık yollarını karşılaştır.", position: "center 35%" },
