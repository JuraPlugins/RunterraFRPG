...
const collections = [
  { href: "/kulliyat/siniflar", image: "/art/classes-cover.png", title: "Sınıflar", kicker: "12 sınıf · 24 uzmanlık", description: "Savaş alanında hangi araçlarla iz bırakacağını seç. Her sınıfın rolünü, kaynağını ve uzmanlık yollarını karşılaştır.", position: "center 35%" },
