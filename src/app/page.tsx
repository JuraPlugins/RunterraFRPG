    ...
    <>
      <section className="hero shell">
        <div className="hero-copy">
          ...
          <p className="hero-lead">On iki bölge, altı sınıf ve binlerce kombinasyon. Kuralları keşfet, karakterini yarat ve sıradan bir maceracıdan dünyayı değiştiren bir güce dönüş.</p>
